...
public class Patient extends AbstractEntity {
    ...
    /**
     * Creates a new {@link Patient} from given surname, first name, name with initials, gender, date of birth, address, mobile, landLine, preferred mode of communication and details of referral object
     *
     ...
     */
    public Patient(String surname, String firstName, String nameWithInitials, Sex gender, LocalDate dateOfBirth, String address, String mobile, String landLine, String preferredModeOfCommunication, DetailsOfReferral detailsOfReferral) {
